...
$FileMappings = @(
    ...
    [pscustomobject]@{ RelativePath = "docs/20_runtime/gameplay_flow.md" },
    ...
    [pscustomobject]@{ RelativePath = "docs/30_resources/debug_trace_contract.md" },
    [pscustomobject]@{ RelativePath = "docs/90_playable/PLAYABLE_V1_TODO.md" },
    [pscustomobject]@{ RelativePath = "docs/90_playable/ITEM_REFACTOR_CLOSURE_TODO.md" },
