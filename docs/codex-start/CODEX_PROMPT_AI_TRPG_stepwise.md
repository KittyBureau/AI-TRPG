...
**文档要求**
- `docs/01_architecture.md`：分层与职责（简版）
- `docs/02_storage_layout.md`：存档文件结构与字段说明（最小版）
...
**文档要求**
- `docs/03_settings.md`：settings 定义、patch、校验与扩展方式
- `docs/04_dialog_types.md`：对话类型定义与判定规则（当前为规则引擎，未来可换模型）
...
**文档要求**
- `docs/05_tools.md`：工具清单、参数、拒绝原因枚举、失败反馈
- `docs/06_state_machine.md`：状态与工具裁决矩阵（强烈建议表格）
...
## 4) 文档交付要求（强制）
每阶段结束必须更新 `docs/`，并在 `docs/README.md` 中维护目录与最新版本号。
