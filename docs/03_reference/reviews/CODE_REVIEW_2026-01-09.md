...
- 已补充路由规格与测试方法文档：`docs/03_reference/design/dialog_routing.md`、`docs/_archive/2026-01-15/legacy/dialog_routing_test_method.md`。
...
- 依据 `docs/_archive/2026-01-15/todo_context.md` 推进关键事实抽取、自动摘要与回归验证，补齐上下文压缩链路。
- 依据 `docs/03_reference/ai-trpg/project/todo.md` 完成 M0–M3 里程碑：严格 TurnOutput JSON、工具白名单、Summary 写回、单次工具提交与并发稳定性。
