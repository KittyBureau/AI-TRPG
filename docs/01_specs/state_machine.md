...
| State | move | move_options | hp_delta | map_generate | world_generate |
| --- | --- | --- | --- | --- | --- |
| alive | allow | allow | allow | allow | allow |
| dying | reject | reject | allow if delta > 0 on actor | reject | reject |
| unconscious | reject | reject | reject | reject | reject |
| restrained_permanent | reject | reject | reject | reject | reject |
| dead | reject | reject | reject | reject | reject |
